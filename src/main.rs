...
static FONT: FontFamily = FontFamily::Named("Comic Sans MS");

fn label(text: impl Into<masonry::ArcStr>) -> Label {
    Label::new(text).with_font_family(FONT).with_text_size(40.)
}
